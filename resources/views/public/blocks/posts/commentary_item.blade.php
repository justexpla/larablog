@php /** @var \App\Models\Commentary $commentary */ @endphp
<div class="parent-comment" data-commentary-id="{{$commentary->id}}">
    <div class="media text-muted pt-4">
        ...
        <div class="media-body pb-3 mb-0 lh-125 border-bottom border-gray">
            <strong class="d-block text-gray-dark pb-2 small @if(\Auth::user()->id === $commentary->user->id) bg-light @endif"><a href="{{route('user.show', $commentary->user)}}">{{'@'}}{{$commentary->user->name}}</a></strong>
