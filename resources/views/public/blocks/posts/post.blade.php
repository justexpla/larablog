@if( !(\Auth::user() instanceof \App\Models\User) || ! \Auth::user()->hasOnBlackList($post->user->id))  {{--господи, какой пиздец. Но это работает. todo - ну наверняка должно быть что-то проще--}}
